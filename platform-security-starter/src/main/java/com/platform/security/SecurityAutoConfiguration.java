...
public class SecurityAutoConfiguration {
    ...
    public KeycloakAdminClient keycloakAdminClient(
        ...
        return new KeycloakAdminClient(restClientBuilder, authorizedClientManager, adminBaseUri);
    }

    @Bean
    public KeycloakTokenClient keycloakTokenClient(RestClient.Builder restClientBuilder,
                                                     ClientRegistrationRepository clientRegistrationRepository) {
        return new KeycloakTokenClient(restClientBuilder, clientRegistrationRepository);
    }
}
