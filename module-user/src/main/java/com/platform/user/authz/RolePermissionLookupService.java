...
/**
 * The single implementation of RolePermissionLookupPort in the system. platform-security-spring-boot-starter
 * only knows this interface - swapping this for a call to a dedicated authorization microservice later
 * requires touching only this class, no @PreAuthorize annotation anywhere else changes.
 */
@Service
public class RolePermissionLookupService implements RolePermissionLookupPort {

    private final RolePermissionRepository repository;

    public RolePermissionLookupService(RolePermissionRepository repository) {
